...
public class B2GetFileInfoRequest {
    ...
    private B2GetFileInfoRequest(String fileId) {
        this.fileId = fileId;
    }
    ...
    public boolean equals(Object o) {
        ...
        B2GetFileInfoRequest that = (B2GetFileInfoRequest) o;
    ...
    public static class Builder {
        ...
        public B2GetFileInfoRequest build() {
            return new B2GetFileInfoRequest(fileId);
        }
    }
}
