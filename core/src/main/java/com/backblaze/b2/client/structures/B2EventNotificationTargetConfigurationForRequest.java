...
/**
 * A destination for an event notification.  Used in B2EventNotificationRuleForRequest.
 */
@B2Json.union(typeField = "targetType")
public class B2EventNotificationTargetConfigurationForRequest {
    ...
    public static B2JsonUnionTypeMap getUnionTypeMap() throws B2JsonException {
        return B2JsonUnionTypeMap
                .builder()
                .put("webhook", B2WebhookConfigurationForRequest.class)
                .build();
    }
}
