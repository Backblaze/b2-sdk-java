...
public class B2JsonInferredParametersTest extends B2BaseTest {
    ...
    private static class DiscardingIgnoredFieldIsOk {
        ...
        @B2Json.constructor(discards = "b,c")
    ...
    public void testUnknownEnum_tooManyDefaultInvalidEnumValue() throws IOException, B2JsonException {
        ...
        thrown.expect(B2JsonException.class);
        thrown.expectMessage("more than one @B2Json.defaultForInvalidEnumValue annotation in enum class com.backblaze.b2.json.B2JsonInferredParametersTest.Spin");
    ...
    private static class GoodCustomHandler {
        ...
        private static class JsonHandler implements B2JsonTypeHandler<B2JsonInferredParametersTest.GoodCustomHandler> {
            public Type getHandledType() {
                return B2JsonInferredParametersTest.GoodCustomHandler.class;
            }

            public void serialize(B2JsonInferredParametersTest.GoodCustomHandler obj, B2JsonOptions options, B2JsonWriter out) throws IOException {
                out.writeString("GoodCustomHandler");
            }

            public B2JsonInferredParametersTest.GoodCustomHandler deserialize(B2JsonReader in, B2JsonOptions options) throws B2JsonException, IOException {
                return deserialize(in.readString());
            }

            public B2JsonInferredParametersTest.GoodCustomHandler deserializeUrlParam(String urlValue) throws B2JsonException {
                return deserialize(urlValue);
            }

            private B2JsonInferredParametersTest.GoodCustomHandler deserialize(String value) throws B2JsonBadValueException {
                if (!value.equals("GoodCustomHandler")) {
                    throw new B2JsonBadValueException("string isn't a GoodCustomHandler (" + value + ")");
                }
                return new B2JsonInferredParametersTest.GoodCustomHandler();
            }

            public B2JsonInferredParametersTest.GoodCustomHandler defaultValueForOptional() {
                return null;
            }
    ...
    public void testVersionRangeBackwards() throws B2JsonException {
        thrown.expectMessage("last version 1 is before first version 2 in class com.backblaze.b2.json.B2JsonInferredParametersTest$VersionRangeBackwardsClass");
    ...
    public void testConflictingVersions() throws B2JsonException {
        thrown.expectMessage("must not specify both 'firstVersion' and 'versionRange' in class com.backblaze.b2.json.B2JsonInferredParametersTest$VersionConflictClass");
    ...
    private enum Letter {
        ...
        public static class JsonHandler implements B2JsonTypeHandler<B2JsonInferredParametersTest.Letter> {
            @Override
            public Type getHandledType() {
                return B2JsonInferredParametersTest.Letter.class;
            }

            @Override
            public void serialize(B2JsonInferredParametersTest.Letter obj, B2JsonOptions options, B2JsonWriter out) throws IOException {
                out.writeString("b");
            }

            @Override
            public B2JsonInferredParametersTest.Letter deserialize(B2JsonReader in, B2JsonOptions options) throws B2JsonException, IOException {
                return deserializeUrlParam(in.readString());
            }

            @Override
            public B2JsonInferredParametersTest.Letter deserializeUrlParam(String urlValue) {
                B2Preconditions.checkArgument(urlValue.equals("b"));
                return BEE;
            }

            @Override
            public B2JsonInferredParametersTest.Letter defaultValueForOptional() {
                return null;
            }
    ...
    public void testFieldFromWrongTypeInUnion() throws B2JsonException {
        ...
        thrown.expectMessage("unknown field in com.backblaze.b2.json.B2JsonInferredParametersTest$SubclassA: z");
    ...
    public void testSerializeUnregisteredUnionSubType() throws B2JsonException {
        ...
        thrown.expectMessage("class com.backblaze.b2.json.B2JsonInferredParametersTest$SubclassUnregistered isn't a registered part of union class com.backblaze.b2.json.B2JsonInferredParametersTest$UnionAZ");
    ...
    public void testUnionMapHasDuplicateClass() throws B2JsonException {
        thrown.expectMessage("duplicate class in union type map: class com.backblaze.b2.json.B2JsonInferredParametersTest$SubclassF");
    ...
    private static class SecureContainer {
        ...
        @B2Json.constructor
        public SecureContainer(String sensitiveString, String insensitiveString) {
            this.sensitiveString = sensitiveString;
            this.insensitiveString = insensitiveString;
        }
    }
